        ...
        this.clients[client].sort(["-ARRIVAL"], this.clientsRaw[client].flag, async (error, results) => {
            if (error) {
                ...
                for (const result of results) {
                    ...
                    this.log.info("this.clientsRaw[client].att: " + this.clientsRaw[client].att);
                ...
                f.once("end", async () => {
                    ...
                    e.on("message", (next_msg, seqno) => {
                        ...
                        next_msg.on("body", async (stream, info) => {
                            this.log.info("COUNTER: " + JSON.stringify(Object.keys(attrs.struct).length));
                            let mail;
                            try {
                            ...
                            this.log.info("mail: " + JSON.stringify(mail));
                            const att = {
                                ...new_attrs,
                                ...attrs,
                            };
                            if (all_att.attach > 0) {
                                ...
                                this.log.info("mail.text: " + JSON.stringify(mail_header.text));
                                this.log.info("mail.html: " + JSON.stringify(mail_header.html));
                                this.log.info("mail.textAsHtml: " + JSON.stringify(mail_header.textAsHtml));
                            ...
                            this.log.info("ATTA: " + JSON.stringify(all_att));
